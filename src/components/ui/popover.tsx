...
function PopoverContent({
  ...
  sideOffset = 8,
  ...props
}: PopoverPrimitive.Popup.Props & { align?: PopoverPrimitive.Positioner.Props["align"]; sideOffset?: number }) {
  return (
    <PopoverPortal>
